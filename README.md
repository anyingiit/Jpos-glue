...
Clean-room JavaPOS cash-changer stack for brownfield devices (RS-232/TCP) on Linux.
...
[Report a bug](https://github.com/anyingiit/Jpos-glue/issues/new?template=bug_report.yml) · [Request a feature](https://github.com/anyingiit/Jpos-glue/issues/new?template=feature_request.yml)
...
See the [open issues](https://github.com/anyingiit/Jpos-glue/issues) for planned features and known issues.
